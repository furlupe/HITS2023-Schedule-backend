...
namespace Schedule.Utils
{
    public class BlacklistAuthRequirementHandler : AuthorizationHandler<BlacklistAuthRequirement>
    {
        ...
        public BlacklistAuthRequirementHandler(ApplicationContext dbContext, IHttpContextAccessor httpContext)
        {
            _dbContext = dbContext;
            _httpContext = httpContext;
        }

        protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, BlacklistAuthRequirement requirement)
        {
